...
### Window Capture
The window capture code contains a debugging functionality built in, to save each window capture as a jpg to the file systemin real time. The test would simply by to visually inspect each captured image, and compare it to the user's currently open windows manually. 
