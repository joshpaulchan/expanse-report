    ...
    class HandHandler
    {
        ...
        public HandHandler()
        {
            ...
            else
            {
                ...
                buttonSender.SendNotification("", "Hand Detected, tracking started.");
            }
        ...
        public void HandlePush(Direction pushDirection)
        {
            if (handMode == HandMode.Normal)
            {
                ...
                {
                    intervalTimer.Stop();
                    buttonSender.SendNotification("", "Hand moved to back plane.");
            ...
            {
                handMode = HandMode.Normal;
                buttonSender.SendNotification("", "Hand moved to mid plane.");
            }
        }
